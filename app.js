...
async function refresh(){const b=$("#refreshBtn");b.disabled=true;b.textContent="Atualizando...";try{await fetch("https://api.github.com/repos/rhrajahub/RADAR-RH-RAJA/actions/workflows/update-news.yml/dispatches",{method:"POST",headers:{"Accept":"application/vnd.github+json","Content-Type":"application/json"},body:JSON.stringify({ref:"main"})});setTimeout(load,5000)}catch(e){}finally{setTimeout(()=>{b.disabled=false;b.textContent="Atualizar agora"},1500)}}
